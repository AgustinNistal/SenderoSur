...
"[project]/components/routes/routes-listing.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function RoutesListing({ routes }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "RoutesListing.useEffect": ()=>{
            const observer = new IntersectionObserver({
                "RoutesListing.useEffect": (entries)=>{
                    entries.forEach({
                        "RoutesListing.useEffect": (entry)=>{
                            const index = Number(entry.target.getAttribute("data-index"));
                            if (entry.isIntersecting) {
                                setVisibleCards({
                                    "RoutesListing.useEffect": (prev)=>new Set([
                                            ...prev,
                                            index
                                        ])
                                }["RoutesListing.useEffect"]);
            ...
            cardRefs.current.forEach({
                "RoutesListing.useEffect": (ref)=>{
                    if (ref) observer.observe(ref);
                }
            }["RoutesListing.useEffect"]);
            return ({
                "RoutesListing.useEffect": ()=>observer.disconnect()
            })["RoutesListing.useEffect"];
        }
    }["RoutesListing.useEffect"], []);
...
_s(RoutesListing, "FulTIDz1r9uJzlUYpX0nXX/PIgs=");
_c = RoutesListing;
var _c;
__turbopack_context__.k.register(_c, "RoutesListing");
...
//# sourceMappingURL=components_routes_routes-listing_tsx_5720cbe6._.js.map