...
"[project]/hooks/api-helper.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function AuthProvider({ children }) {
            ...
            const bootstrap = {
                "AuthProvider.useEffect.bootstrap": async ()=>{
                    ...
                    if (savedUser) {
                        ...
                        parsed.reservations = parsed.reservations?.map({
                            "AuthProvider.useEffect.bootstrap": (r)=>({
                                    ...r,
                        ...
                        parsed.comments = parsed.comments?.map({
                            "AuthProvider.useEffect.bootstrap": (c)=>({
                                    ...c,
                        ...
                        if (token && parsed.id) {
                            try {
                                const fresh = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$api$2d$helper$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiRequest"])(`/users/${parsed.id}`, {
                                    headers: {
                                        Authorization: `Bearer ${token}`
                                    }
                                });
                                fresh.reservations = fresh.reservations?.map({
                                    "AuthProvider.useEffect.bootstrap": (r)=>({
                                            ...r,
                                            checkIn: new Date(r.checkIn),
                                            checkOut: new Date(r.checkOut),
                                ...
                                fresh.comments = fresh.comments?.map({
                                    "AuthProvider.useEffect.bootstrap": (c)=>({
                                            ...c,
                                            createdAt: new Date(c.createdAt)
                                        })
    ...
    const login = async (email, password)=>{
        try {
            const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$api$2d$helper$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiRequest"])("/auth/login", {
                method: "POST",
                body: JSON.stringify({
                    email,
                    password
    ...
    const register = async (name, email, password)=>{
        try {
            const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$api$2d$helper$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiRequest"])("/auth/register", {
                method: "POST",
                body: JSON.stringify({
                    name,
                    email,
    ...
    const addReservation = async (reservation)=>{
        ...
        const newReservation = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$api$2d$helper$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiRequest"])(`/reservations/${user.id}`, {
            method: "POST",
            headers: token ? {
                Authorization: `Bearer ${token}`
            } : undefined,
    ...
    const addPackReservations = async (reservations)=>{
        ...
        for (const res of reservations){
            ...
            const newRes = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$api$2d$helper$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiRequest"])(`/reservations/${user.id}`, {
                method: "POST",
                headers: token ? {
                    Authorization: `Bearer ${token}`
                } : undefined,
    ...
    const addComment = async (comment)=>{
        if (!user) return;
        const token = localStorage.getItem("sendero-sur-token");
        const newComment = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$api$2d$helper$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiRequest"])(`/comments/${user.id}`, {
            method: "POST",
            headers: token ? {
                Authorization: `Bearer ${token}`
            } : undefined,
    ...
    const updateProfile = async (data)=>{
        if (!user) return;
        const token = localStorage.getItem("sendero-sur-token");
        const updatedUser = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$api$2d$helper$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiRequest"])(`/users/${user.id}`, {
            method: "PATCH",
            headers: token ? {
                Authorization: `Bearer ${token}`
            } : undefined,
    ...
    const cancelReservation = async (reservationId)=>{
        if (!user) return;
        const token = localStorage.getItem("sendero-sur-token");
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$api$2d$helper$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiRequest"])(`/reservations/${reservationId}/cancel`, {
            method: "PATCH",
            headers: token ? {
                Authorization: `Bearer ${token}`
            } : undefined
...
"[project]/lib/en-data.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/jsx-dev-runtime.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$en$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/en-data.ts [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature(), _s1 = __turbopack_context__.k.signature();
"use client";
;
...
function LanguageProvider({ children }) {
    ...
    const translateRoute = (route)=>{
        ...
        // @ts-ignore
        const eng = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$en$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["enDataTranslations"].routes[route.id];
        if (!eng) return route;
        return {
            ...route,
            ...eng
    ...
    const translateCity = (city)=>{
        ...
        // @ts-ignore
        const eng = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$en$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["enDataTranslations"].cities[city.id];
        if (!eng) return city;
        return {
            ...city,
            ...eng
    ...
    const translateAccommodation = (acc)=>{
        ...
        // @ts-ignore
        const eng = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$en$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["enDataTranslations"].accommodations[acc.id];
        if (!eng) return acc;
        return {
            ...acc,
            ...eng
...
_s(AuthModal, "huwG/m4tBWyHNRWh3Arv1kcCa+8=", false, function() {
    return [
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$dropdown$2d$menu$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DropdownMenuTrigger"], {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                    ...
                    className: "w-9 px-0",
                    children: [
                        language === "es" ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
...
_s(LayoutClient, "EBApmYLvz3qFMigDkwGVyqWstRc=", false, function() {
    return [
...
//# sourceMappingURL=_adc1ca56._.js.map